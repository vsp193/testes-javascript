...
var gerenciadorTarefas = new function () {
  ...
  this.carregarTarefas = function () {
    var elementoListaTarefas = jquery('#lista-tarefas'); // Limpa lista no carregamento

    elementoListaTarefas.html(''); // Itera sobre a lista de tarefas para carregar informações
  ...
  this.adicionarTarefa = function () {
    var elementoTituloTarefa = jquery('#titulo-tarefa');
    inserirTarefaNaListagem(elementoTituloTarefa.val());
  };

  function criarElementoTarefa(tarefa) {
    return "\n      <li>\n        <span>".concat(tarefa.titulo, "</span>\n        <input type='checkbox' ").concat(tarefaFoiFeita(tarefa), "/>\n      </li>\n    ");
  }
  ...
  function gerarNovoId() {
    var indexUltimaTarefa = this.listaTarefas.length - 1;
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","src/index.js"], "contexto")
